...
| T008 | Rodar o cenário de T006/T007 contra `docker compose -f docker-compose.yml -f docker-compose.blackbox.yml up` (spec 05-014) — confirmar verde, incluindo o passo que envia `captchaToken` sem resolver o desafio ALTCHA de verdade e o passo que lê o link de login do administrador semeado via `GET /blackbox/last-email` | T007 | | #69 |
