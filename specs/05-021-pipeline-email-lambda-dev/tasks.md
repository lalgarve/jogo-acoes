...
| T005 | Criar `email-lambda/Dockerfile` — multi-stage, builda só `-pl email-lambda -am package -DskipTests` (modo JVM), copia `target/quarkus-app/` para a imagem final, `ENTRYPOINT java -jar quarkus-run.jar` | — | [P] | #78 |
