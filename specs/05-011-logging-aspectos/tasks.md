...
|---|---|---|---|---|
| T001 | Adicionar dependência `spring-boot-starter-aop` ao `app/pom.xml` | — | [P] | #61 |
...
| T010 | Adicionar `logging.level.dev.leilaalgarve.jogoacoes: DEBUG` em `app/src/main/resources/application.yml` — é esse nível que faz os três aspectos aparecerem no console; sem ele, T007/T008/T009 continuam vermelhos mesmo com os aspectos implementados | T007, T008, T009 | | #61 |
