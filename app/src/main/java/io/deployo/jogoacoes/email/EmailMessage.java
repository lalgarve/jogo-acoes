...
/**
 * The SQS command-queue message contract (docs/iteracao-4.md, decisão 1) — producer-side copy.
 * email-lambda has its own identical copy on the consumer side; kept as two separate records,
