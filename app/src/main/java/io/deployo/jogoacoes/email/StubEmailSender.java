 ...
 * of which set {@code email.sender} (docs/context/iteracao-4.md, decisão 3 -- no Docker/network
 * there, so there's nothing to publish to). Not a {@code @Profile} switch on purpose: the test
