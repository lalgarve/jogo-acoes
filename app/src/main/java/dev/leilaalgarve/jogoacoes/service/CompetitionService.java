...
import dev.leilaalgarve.jogoacoes.domain.CompetitionStatus;
import dev.leilaalgarve.jogoacoes.domain.CompetitionType;
import dev.leilaalgarve.jogoacoes.domain.EmailTemplate;
import dev.leilaalgarve.jogoacoes.domain.LogType;
import dev.leilaalgarve.jogoacoes.domain.LoginLink;
import dev.leilaalgarve.jogoacoes.domain.Participation;
import dev.leilaalgarve.jogoacoes.domain.ParticipationStatus;
...
import dev.leilaalgarve.jogoacoes.repository.CompetitionRepository;
import dev.leilaalgarve.jogoacoes.repository.LoginLinkRepository;
import dev.leilaalgarve.jogoacoes.repository.ParticipationRepository;
import dev.leilaalgarve.jogoacoes.repository.UserRepository;
import dev.leilaalgarve.jogoacoes.web.CompetitionNotFoundException;
import dev.leilaalgarve.jogoacoes.web.CompetitionValidationException;
...
public class CompetitionService {
    ...
    @Transactional
    public dev.leilaalgarve.jogoacoes.domain.Competition create(CompetitionCreateRequest request) {
        validate(request);

        dev.leilaalgarve.jogoacoes.domain.Competition competition = new dev.leilaalgarve.jogoacoes.domain.Competition();
    ...
    public void decideInviteEmailTiming(Long competitionId, DecideInviteEmailTimingRequest.TimingEnum timing) {
        dev.leilaalgarve.jogoacoes.domain.Competition competition = competitionRepository.findById(competitionId)
