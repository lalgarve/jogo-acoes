...
import dev.leilaalgarve.jogoacoes.common.testsupport.LoginHelper;
...
public class RequestCompetitionEntrySteps {
    ...
    public void the_system_resends_the_link_to_finish_registration_by_e_mail() {
        ...
        List<dev.leilaalgarve.jogoacoes.email.SentEmail> sentForEmail = sentEmailRepository.findAll().stream()
