package dev.leilaalgarve.jogoacoes.testsupport;
...
public class LoginLinkFixtures {
    ...
    public LoginLink pendingParticipationLink(dev.leilaalgarve.jogoacoes.domain.Competition competition, String email, RequestType requestType) {
