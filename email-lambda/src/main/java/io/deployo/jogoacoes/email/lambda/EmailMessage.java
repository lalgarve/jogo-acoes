...
/**
 * The SQS command-queue message contract (docs/context/iteracao-4.md, decision 1). Mirrors the
 * shape the main app's future EmailSender implementation publishes -- duplicated here rather than
